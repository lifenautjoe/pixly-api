import { UserStatus } from "./../models/user-status/UserStatus";
...
export function deserializeUserStatus(data: IUserStatusData) {
  return deserializeModel<IUserStatusData, IUserStatus>(data, UserStatus);
}
